...
export default function FoldSparkleButton({ label, onClick, className }: Props) {
  return (
      ...
      <style jsx>{`
        .button {
          ...
          background: radial-gradient(
            ...
            linear-gradient(0deg, #8b5cf6, #8b5cf6);
          ...
          box-shadow:
            0 18px 55px rgba(17, 24, 39, 0.18),
        ...
        .fold {
          ...
          box-shadow: 0 0 3px rgba(17, 24, 39, 0.7);
